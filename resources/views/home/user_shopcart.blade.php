    ...
    <div class="section">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <!-- /ASIDE -->
                <div class="hasan5 card col-md-10" style="border: 1px solid black; border-radius: 20px; padding: 50px;position: relative; ">
                    ...
                    <div class="card-body">
                        ...
                        <table class="shopping-cart-table table">
                            ...
                            @foreach ( $datalist as $rs)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{route('user_shopcart_update',['id' => $rs->id])}}" method="post" style="position:relative;">
                                            @csrf
                                            <input  style="position:absolute;  left: 35%; top: -12px;" name="quantity" type="number" value="{{$rs->quantity}}" min="1" max="{{$rs->product->quantity}}" onchange="this.form.submit()">
                                        </form>
                        ...
                        <form action="{{route('user_order_add')}}" method="post">
                            ...
                            <div class="pull-right">
                                <button type="submit" class="primary-btn" style="position:absolute; left: 40%; background-color: #30323A; color: white;border-radius: 20px;">SİPARİŞİ TAMAMLA</button>
                            </div>
                        </form>
                    </div>
                    <!-- /.card-body -->
